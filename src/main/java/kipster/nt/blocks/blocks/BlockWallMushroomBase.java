...
public class BlockWallMushroomBase extends BlockRotatedPillar implements IHasModel {

    protected static final AxisAlignedBB FLOWER_AABB = new AxisAlignedBB(0.1D, 0.0D, 0.1D, 0.9D, 0.8D, 0.9D);

    public BlockWallMushroomBase(String name, Material material) {
        super(material); // Call the superclass constructor with the 'material' parameter
