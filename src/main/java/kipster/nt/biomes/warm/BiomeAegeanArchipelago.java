...
import kipster.nt.world.gen.trees.WorldGenTreeAutumnOrange;
...
public class BiomeAegeanArchipelago extends Biome {
	...
	public void decorate(World worldIn, Random rand, BlockPos pos) {
		...
		// Add coral reefs using a custom WorldGenerator
		WorldGenerator coralReefGenerator = new CoralReefGenerator();
		coralReefGenerator.generate(worldIn, rand, pos);

		WorldGenerator cypressTreeGenerator = new CypressTreeGenerator();
		cypressTreeGenerator.generate(worldIn, rand, pos);

		WorldGenerator lavenderGenerator = new LavenderGenerator();
		lavenderGenerator.generate(worldIn, rand, pos);

		WorldGenerator thymeGenerator = new ThymeGenerator();
		thymeGenerator.generate(worldIn, rand, pos);

		WorldGenerator rosemaryGenerator = new RosemaryGenerator();
		rosemaryGenerator.generate(worldIn, rand, pos);
...
//#todo
	...
	//#todo
	private static class CypressTreeGenerator extends WorldGenerator {
		@Override
		public boolean generate(World worldIn, Random rand, BlockPos pos) {
