...
public class WorldGenTreeBigPalmTree extends WorldGenAbstractTree {
    private Random rand;
    private World world;
    ...
    void generateLeafNodeList() {
        ...
        this.foliageCoords.add(new WorldGenTreeBigPalmTree.FoliageCoordinates(this.basePos.up(k), j));
                ...
                for (int l = 0; l < i; ++l) {
                    ...
                    if (this.checkBlockLine(blockpos, blockpos1) == -1) {
                        ...
                        if (this.checkBlockLine(blockpos2, blockpos) == -1) {
                            this.foliageCoords.add(new WorldGenTreeBigPalmTree.FoliageCoordinates(blockpos, blockpos2.getY()));
                        }
                    }
                }
            }
    ...
    void generateLeafNode(BlockPos pos) {
        IBlockState leaves = Blocks.LEAVES.getDefaultState()
                ...
                .withProperty(BlockLeaves.DECAYABLE, Boolean.valueOf(false));
    ...
    void generateLeaves() {
        for (WorldGenTreeBigPalmTree.FoliageCoordinates WorldGenTreeBigRedOak$foliagecoordinates : this.foliageCoords) {
